            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (!(discussion.lastMessage == null)) {
                  if (discussion.lastMessage!.isMine()) {
                    subtitle += 'vous';
                  } else if (discussion.lastMessage!.messageType == 'image' ||
                      discussion.isGroupChat) {
                    subtitle += discussion.lastMessage!.senderName;
                  }
                  if (discussion.lastMessage!.messageType == 'image') {
                    subtitle += (discussion.lastMessage!.isMine())
                        ? ' avez envoyé une image'
                        : ' a envoyé une image';
                  } else {
                    subtitle += ((discussion.lastMessage!.isMine() ||
                                discussion.isGroupChat)
                ...
                //         : ''
                //     : '';
                // subtitle = subtitle + ((discussion.lastMessage?.message) ?? '');
